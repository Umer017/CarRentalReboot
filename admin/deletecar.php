...
<nav class="nav">
        ...
        <li class="nav-item dropdown">
          ...
          <li class="nav-item">
            <a class="nav-link " href="carListing.php" tabindex="-1" aria-disabled="true">add car</a>
        </li>
          <li class="nav-item ml-auto">
         <a class="nav-link " href="userProfile.php?id=<?php  ?>" tabindex="-1" aria-disabled="true"><?php ?><img src="images/user.png" alt="" style="width: 40px;" class="ml-3"></a>
        </li>
    </nav>
  ...
  <div class="card-body">
    ...
    <a href="performdelete.php?carid=<?php echo $fetchData['VID']; ?>" class="btn btn-primary">DeleteCar</a>
  </div>
    </div>
    <?php } ?>
</div>
